...
#define FLT_EPSILON                                                            \
   1.19209290e-07f /**< Smallest float x where 1.0 + x != 1.0 */
...
#define DBL_EPSILON                                                            \
   2.2204460492503131e-16 /**< Smallest double x where 1.0 + x != 1.0 */
...
#define LDBL_EPSILON                                                           \
   1.0842021724999998051e-19L /**< Smallest long double x where 1.0 + x != 1.0 \
                               */
